...
import { resetPassword } from "../../services/apiOperations/authOp";
import { LoadingSpinner } from "../Wrapper/PageWrapper";
      ...
      {loading ? (
        ...
        <div className="max-w-[500px] p-4 lg:p-8">
          ...
          <form onSubmit={handleOnSubmit}>
            ...
            <button
              type="submit"
              className="mt-6 w-full rounded-[8px] bg-primary py-[12px] px-[12px] font-medium text-white"
            >
              Reset Password
            </button>
          </form>
