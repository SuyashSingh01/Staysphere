    ...
    <>
      <nav className="flex justify-around items-center gap-x-10 sm:gap-x-4 sm:py-4 py-1 w-full sticky top-[83px] z-50 bg-white mx-auto">
        ...
        <div className="relative xl:w-[70%] lg:w-[62%] sm:w-full w-[80%] flex justify-between ">
          ...
          {canScrollLeft && (
            <ArrowButton
              ...
              direction="prev"
              style="absolute left-0 bg-orange-400 border-2 sm:flex border-gray-300 hover:scale-[1.05] hover:shadow-lg z-50"
            />
          )}
          ...
          {canScrollRight && (
            <ArrowButton
              ...
              direction="next"
              style="absolute right-0 bg-orange-400 border-2 sm:flex border-gray-300 hover:scale-[1.05] hover:shadow-lg z-50"
            />
          )}
          {/* Filters Section */}
        </div>
        <div className="hidden md:block">
          <button
            className="flex items-center bg-orange-400 gap-2 border px-3 py-2 rounded-full text-white-700 hover:shadow text-sm sm:text-base m"
